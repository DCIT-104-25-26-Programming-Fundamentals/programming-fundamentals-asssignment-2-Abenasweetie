...
// Function for Modulus (casts doubles to integers)
    ...
    while (choice != 7) {
        ...
        if (choice >= 1 && choice <= 6) {
            ...
            switch (choice) {
                ...
                case 3:
                    cout << "Result: " << num1 << " * " << num2 << " = " 
                         << multiplyNumbers(num1, num2) << endl;
                    break;
                ...
                case 5:
                    if (static_cast<int>(num2) == 0) {
                        ...
                        cout << "Result: " << int1 << " % " << int2 << " = " 
                             << modulusNumbers(int1, int2) << endl;
                    }
                    break;

                case 6:
                    cout << "Result: " << num1 << " ^ " << num2 << " = " 
                         << powerNumbers(num1, num2) << endl;
                    break;
            }
        } else if (choice == 7) {
            cout << "Goodbye!" << endl;
